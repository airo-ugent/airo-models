...
AIRO_MODEL_NAMES = ["ur3e", "ur5e", "ur5e_collision_primitives", "robotiq_2f_85"]
...
def get_urdf_path(name: str) -> str:
    ...
    name_to_urdf_path = {
        ...
        "ur5e_collision_primitives": os.path.join(
            airo_models_dir, "arms", "ur5e", "ur5e_primitives.urdf"
        ),
